// Use an instance method reference with differetn objects.
// 
...
class InstanceMethWithObjectRefDemo {
    ...
    public static void main(String[] args) {
        ...
        HighTemp[] weekDayHighs2 = { new HighTemp(32), new HighTemp(12), new HighTemp(24), new HighTemp(19),
                new HighTemp(18), new HighTemp(12), new HighTemp(18), new HighTemp(12), new HighTemp(-1),
                new HighTemp(13) };
