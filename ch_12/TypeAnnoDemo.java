...
// Still another marker annotation that can be applied to type.
@Target(ElementType.TYPE_USE)
@interface Unique {
}
...
// An annotatiuon can be applied to a method declaration
@Target(ElementType.METHOD)
@interface Recommended {
}

// Use an annotation on a type
